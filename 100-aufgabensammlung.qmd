...
2. Bestimmen Sie das optimale $K$ für die KNN Klassifikation mit der Methode des Test- und Trainingsdatensatzes. Erklären Sie den Code.
```{r}
k <- 1:50
...
3. Plotten Sie die Klassifikationsfehlerrate.
4. Variieren Sie den Seed und untersuchen Sie, wie sich die Klassifikationsfehlerrate dadurch verändert.

5. Bestimmen Sie jetzt das optimale $K$ durch die Kreuzvalidierung. Erklären Sie den Code.
```{r}
k <- 1:50
